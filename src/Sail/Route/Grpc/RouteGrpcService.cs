...
using GrpcRouteService = Sail.Api.V1.RouteService;

namespace Sail.Route.Grpc;

public class RouteGrpcService(IRouteStore routeStore) : GrpcRouteService.RouteServiceBase
{
    ...
    private static ListRouteResponse MapToRouteItemsResponse(List<RouteEntity> routes)
    {
    ...
    private static RouteResponse MapToRouteResponse(RouteEntity route)
    {

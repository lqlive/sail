...
namespace Sail.AuthenticationPolicy;
...
public class AuthenticationPolicyService
{
    ...
    private static AuthenticationPolicyEntity CreatePolicyFromRequest(AuthenticationPolicyRequest request)
    {
        return new AuthenticationPolicyEntity
        {
            Id = Guid.NewGuid(),
            Name = request.Name,
            Type = request.Type,
    ...
    private static AuthenticationPolicyResponse MapToResponse(AuthenticationPolicyEntity policy)
    {
